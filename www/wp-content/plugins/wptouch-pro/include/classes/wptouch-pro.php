...
//			echo "<![endif]-->\n";
		...
		if ( $can_show_ads ) { 
			if ( $this->get_active_device_class() == 'ipad' ) {
				switch( $settings->ipad_advertising_type ) {
					case 'custom':
						echo $settings->custom_ipad_advertising_code;
						break;
					default:
				...
				switch( $settings->advertising_type ) {
					...
					case 'google':
						...
						break;
					case 'custom':
						echo $settings->custom_advertising_code;
						break;
					default:
						// Try to get this advertising type from a plugin
	...
	function check_plugins_for_warnings() {
		...
		if ( WPTOUCH_SIMULATE_ALL || function_exists( 'wp_super_cache_init' ) ) {
			$this->add_warning( 'WP Super Cache', __('Configuration is required to work with WPtouch Pro. It must configured to exclude the user agents that WPtouch Pro is enabled for (iphone, ipod, incognito, webmate,android, dream, cupcake, froyo,blackberry9500, blackberry9520, blackberry9530, blackberry9550, blackberry 9800, 	blackberry 9850, blackberry 9860, blackberry 9780, blackberry 9790, blackberry 9900, blackberry 9930, blackberry 9350, blackberry 9360, blackberry 9370, blackberry 9380, blackberry 9810,iemobile/7.0, iemobile/9.0,webos,s8000, bada,googlebot-mobile, adsbot-google)', 'wptouch-pro' ),  '' );	
		}
		
		if ( WPTOUCH_SIMULATE_ALL || class_exists( 'W3_Plugin_TotalCache' ) ) {
			$this->add_warning( 'W3 Total Cache', __('Extra configuration is required. It must be configured to exclude the user agents that WPtouch Pro is enabled for (iphone, ipod, incognito, webmate,android, dream, cupcake, froyo,blackberry9500, blackberry9520, blackberry9530, blackberry9550, blackberry 9800, 	blackberry 9850, blackberry 9860, blackberry 9780, blackberry 9790, blackberry 9900, blackberry 9930, blackberry 9350, blackberry 9360, blackberry 9370, blackberry 9380, blackberry 9810,iemobile/7.0, iemobile/9.0,webos,s8000, bada,googlebot-mobile, adsbot-google)', 'wptouch-pro' ), '' );	
		}
		
		if ( WPTOUCH_SIMULATE_ALL || function_exists( 'hyper_activate' ) ) {
			$this->add_warning( 'Hyper Cache', __('Extra configuration is required. You must enable the "Detect mobile devices" option, and add these user agents that WPtouch Pro is enabled for (iphone, ipod, incognito, webmate,android, dream, cupcake, froyo,blackberry9500, blackberry9520, blackberry9530, blackberry9550, blackberry 9800, 	blackberry 9850, blackberry 9860, blackberry 9780, blackberry 9790, blackberry 9900, blackberry 9930, blackberry 9350, blackberry 9360, blackberry 9370, blackberry 9380, blackberry 9810,iemobile/7.0, iemobile/9.0,webos,s8000, bada,googlebot-mobile, adsbot-google) to the Mobile agent list.', 'wptouch-pro' ) );	
		}
		...
		if ( WPTOUCH_SIMULATE_ALL || function_exists( 'cfmobi_check_mobile' ) ) {
			$this->add_warning( 'WP Mobile Edition', __( 'WP Mobile edition should be configured to exclude the user agents that WPtouch Pro is enabled for (iphone, ipod, incognito, webmate,android, dream, cupcake, froyo,blackberry9500, blackberry9520, blackberry9530, blackberry9550, blackberry 9800, 	blackberry 9850, blackberry 9860, blackberry 9780, blackberry 9790, blackberry 9900, blackberry 9930, blackberry 9350, blackberry 9360, blackberry 9370, blackberry 9380, blackberry 9810,iemobile/7.0, iemobile/9.0,webos,s8000, bada,googlebot-mobile, adsbot-google).', 'wptouch-pro' ) );
		}
...
//		}
	...
	function get_supported_theme_device_classes() {		
		...
		foreach( $wptouch_device_classes as $class_name => $class_info ) {
			if ( isset( $supported_device_classes[ $class_name ] ) ) {
	...
	function get_excluded_user_agents() {
		global $wptouch_exclusion_list;

		return apply_filters( 'wptouch_exclusion_list', $wptouch_exclusion_list );
	}
